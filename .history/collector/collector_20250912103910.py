...
class HyprlandCollector:
    ...
    def _get_active_window_info(self) -> Optional[WindowInfo]:
        ...
        try:
            ...
            app_name = window_info.get('class', 'Unknown')
    ...
    def _save_event(self, window_info: WindowInfo):
        ...
        try:
            ...
            cursor.execute("""
                INSERT INTO events (timestamp, device_type, app_name, window_title, process_name, duration_seconds)
                VALUES (?, ?, ?, ?, ?, ?)
            """, (
            ...
            try:
                ...
                if current_window:
                    ...
                    if (self.last_window_info is None or 
                        ...
                        current_window.window_title != self.last_window_info.window_title):
                        
                        self.logger.info(f"Active: {current_window.app_name} - {current_window.window_title}")
